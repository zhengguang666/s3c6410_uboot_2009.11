...
#define S3C64XX_MEM_SYS_CFG_NAND	0x000d
...
#if defined(CONFIG_CLK_667_133_66) /* FIN 12MHz, Fout 666MHz */
#define APLL_MDIV	333
#define APLL_PDIV	3
#define APLL_SDIV	1
#undef  CONFIG_SYNC_MODE     /* ASYNC MODE */

#elif defined(CONFIG_CLK_533_133_66) /* FIN 12MHz, Fout 532MHz */
#define APLL_MDIV	266
#define APLL_PDIV	3
#define APLL_SDIV	1
#define CONFIG_SYNC_MODE

/* FIN 12MHz, Fout 800MHz */
...
#define STARTUP_APLL    (((CONFIG_SYS_CLK_FREQ >> APLL_SDIV) / APLL_PDIV) * APLL_MDIV)
...
#define STARTUP_MPLL    (((CONFIG_SYS_CLK_FREQ >> MPLL_SDIV) / MPLL_PDIV) * MPLL_MDIV)
...
#define STARTUP_HCLK	(STARTUP_APLL / (STARTUP_HCLKX2DIV + 1) / \
	(STARTUP_HCLKDIV + 1))
#else
 ...
 * Physical Memory Map
 */
#if (PHYS_SDRAM_1_SIZE == 0x08000000) /* 128 MB */
#define DMC1_MEM_CFG	0x00010012	/* Chip1, Burst4, Row(13-bit)/Column(10-bit) */
#define DMC1_CHIP0_CFG	0x150F8		/* 0x5000_0000 ~ 0x57ff_ffff (128MB) */

#elif (PHYS_SDRAM_1_SIZE == 0x10000000) /* 256 MB */ 
#define DMC1_MEM_CFG	0x0001001a	/* Chip1, Burst4, Row(13-bit)/Column(10-bit) */
#define DMC1_CHIP0_CFG	0x150F0		/* 0x5000_0000 ~ 0x57ff_ffff (128MB) */

#else
#error "Only support 128 MB and 256 MB DDR."
#endif
